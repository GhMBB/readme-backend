...
class ComentariosController < ApplicationController
  ...
  def create
    ...
    if libro.nil?
      ...
      render json: { message: 'Comentario creado exitosamente', comentario: ComentarioSerializer.new(@comentario) },
             status: :created
    end
  end
  ...
  def update
    ...
    if @comentario.nil? && (@comentario.deleted != true)
      ...
      render json: { message: 'Comentario actualizado exitosamente', comentario: ComentarioSerializer.new(@comentario) },
             status: :ok
    end
  end
  ...
  def find_by_user_and_libro
    ...
    if params[:user_id].present?
      ...
      comentarios = Comentario.where(user_id: params[:user_id], libro_id: params[:libro_id],
