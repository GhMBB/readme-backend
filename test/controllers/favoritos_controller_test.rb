...
class FavoritosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorito" do
    assert_difference("Favorito.count") do
      post favoritos_url, params: { favorito: { favorito: @favorito.favorito, libro_id: @favorito.libro_id, user_id: @favorito.user_id } }, as: :json
    end
  ...
  test "should update favorito" do
    patch favorito_url(@favorito), params: { favorito: { favorito: @favorito.favorito, libro_id: @favorito.libro_id, user_id: @favorito.user_id } }, as: :json
    assert_response :success
  end
